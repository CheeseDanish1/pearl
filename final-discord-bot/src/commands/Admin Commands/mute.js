module.exports.run = (client, message, args) => {
  ...
  if (!message.guild.me.hasPermission('MANAGE_ROLES'))
    return message.channel.send('I do not have permission to mute people.');
  ...
  user
    .send(`You are muted in **${message.guild.name}** For \`${reason}\``)
...
module.exports.info = {
  ...
  alias: ['shutup'],
  usage: '<p>Mute [Member]',
  example: '<p>Mute @Jimmy#7932',
  description: 'Permanatly prevent server member from sending messages',
  category: 'moderation',
};
