...
module.exports.run = (client, message, args) => {
  ...
  let channel = message.mentions.channels.first()  || (args[0] && message.guild.channels.cache.get(args[0]))
  let poll = args.slice(1).join(" ")
  if (!channel) return message.channel.send("Please provide the channel you would like me to ask the poll in")
