  ...
  switch (changed) {
    case 'joined':
      embed
        ...
        .setDescription(
          `\`${who.username}\` joined voice channel \`${channel.name}\``
        )
    ...
    case 'left':
      embed
        ...
        .setDescription(
          `\`${who.username}\` left voice channel \`${channel.name}\``
        )
        .setFooter(`Person Id: ${who.id} || Channel Id: ${channel.id}`);
      x.send(embed).catch();
      break;
    case 'muted':
      embed
        .setTitle(`Muted`)
        .setDescription(
          `\`${who.username}\` was muted in channel \`${channel.name}\``
        )
        .setFooter(`Person Id: ${who.id} || Channel Id: ${channel.id}`);
      x.send(embed).catch();
      break;
    case 'unmuted':
      embed
        .setTitle(`Unmuted`)
        .setDescription(
          `\`${who.username}\` was unmuted in channel \`${channel.name}\``
        )
        .setFooter(`Person Id: ${who.id} || Channel Id: ${channel.id}`);
      x.send(embed).catch();
      break;
